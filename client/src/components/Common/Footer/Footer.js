          ...
          <AnimatedElement className=" flex-grow flex flex-wrap mb-10 text-left order-first">
            <div className="lg:w-2/5 md:w-1/2 w-full px-4">
              ...
              <li> 
                  ...
                  <Link href="/academics/departments/comp" className="text-white hover:text-gray-300 cursor-pointer"> &#8658; Computer Engineering</Link>
                </li>
                <li>
                  <Link href="/academics/departments/it" className="text-white hover:text-gray-300 cursor-pointer"> &#8658; Information Technology</Link>
                </li>
                <li>
                  <Link href="/academics/departments/aiml" className="text-white hover:text-gray-300 cursor-pointer"> &#8658; Artificial Intelligence & Machine Learning</Link>
                </li>
                <li>
                  <Link href="/academics/departments/ee" className="text-white hover:text-gray-300 cursor-pointer"> &#8658; Electrical Engineering</Link>
                </li>
                <li>
                  <Link href="/academics/departments/ds" className="text-white hover:text-gray-300 cursor-pointer"> &#8658; Data Science </Link>
                </li>
                <li>
                  <Link href="/academics/departments/me" className="text-white hover:text-gray-300 cursor-pointer"> &#8658; Mechanical Engineering</Link>
                </li>
                <li>
                  <Link href="/academics/departments/civil" className="text-white hover:text-gray-300 cursor-pointer"> &#8658; Civil Engineering</Link>
                </li>
              </nav>
            </div>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-bold text-white tracking-widest text-lg mb-3">B. E Syllabus</h2>
              <nav className="list-none mb-10">
                <li>
                  <a target='_blank' href='https://makautexam.net/aicte_details/CourseStructure/CSBS20.pdf' className="text-white hover:text-gray-300 cursor-pointer"> &#8658; COMP</a>
                </li>
                <li>
                  <a target='_blank' href='https://makautexam.net/aicte_details/CourseStructure/CSE.pdf' className="text-white hover:text-gray-300 cursor-pointer"> &#8658; IT</a>
                </li>
                <li>
                  <a target='_blank' href='https://makautexam.net/aicte_details/CourseStructure/ECE.pdf' className="text-white hover:text-gray-300 cursor-pointer"> &#8658; AIML</a>
                </li>
                <li>
                ...
                <li>
                  <a target='_blank' href='https://makautexam.net/aicte_details/CourseStructure/EEE.pdf' className="text-white hover:text-gray-300 cursor-pointer"> &#8658; DS</a>
                </li>
                <li>
                ...
                <li>
                  <a target='_blank' href='https://makautexam.net/aicte_details/CourseStructure/ME.pdf' className="text-white hover:text-gray-300 cursor-pointer"> &#8658; CIVIL</a>
                </li>
              </nav>
            </div>
            {/* Admission Enquiry */}
            ...
            {/* AOT Online */}
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-bold text-white tracking-widest text-lg mb-3">YTIET Online</h2>
              <nav className="list-none mb-10">
                <li>
                ...
                <li>
                  <a target='_blank' href='' className="text-white hover:text-gray-300 cursor-pointer"> &#8658; Moodle Portal Login</a>
                </li>
                <li>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <p className="text-white hover:text-gray-300 cursor-pointer">Village Chandhai,</p>
              <p className="text-white hover:text-gray-300 cursor-pointer">Post Nasrapur,</p>
              <p className="text-white hover:text-gray-300 cursor-pointer">Bhivpuri Road Railway Station, Tal.Karjat,</p>
              <p className="text-white hover:text-gray-300 cursor-pointer">Raigad , 410201 Maharashtra</p>
              <p className="text-white hover:text-gray-300 cursor-pointer">principal.ytiet@tasgoankartech.com</p>
              <h4 className="text-white hover:text-gray-300 cursor-pointer">+91 97681-40203</h4>
            </div>
        ...
        <div>
          <div>
            <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
              <p className="text-gray-300 text-sm text-center sm:text-left">© 2024 YTIET —
                <a rel="noopener noreferrer" className="text-gray-300 ml-1" target="_blank">@ytiet</a>
              </p>
